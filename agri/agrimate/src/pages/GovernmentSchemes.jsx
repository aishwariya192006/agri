...
const schemes = [
  ...
  { id: 5, title: 'PM Krishi Sinchai Yojana', category: 'Irrigation', benefit: 'Subsidy on irrigation', eligibility: 'Farmers with water source access', deadline: '15 Mar 2027', match: 83, desc: 'Ensures access to protective irrigation to all agricultural farms to produce "more crop per drop".' },
